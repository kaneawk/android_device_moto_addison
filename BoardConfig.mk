...
BOARD_MKBOOTIMG_ARGS :=  --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --kernel_offset 0x00008000 --second_offset 0x00f00000 --dt device/moto/addison/dt.img
BOARD_CUSTOM_BOOTIMG_MK := device/moto/addison/mkbootimg.mk
TARGET_PREBUILT_KERNEL := device/moto/addison/kernel
...
TARGET_CRYPTFS_HW_PATH := device/moto/addison/cryptfs_hw
# Keymaster - Wait for qseecom to load
TARGET_KEYMASTER_WAIT_FOR_QSEE := true
# Recovery
BOARD_HAS_NO_SELECT_BUTTON := true
TARGET_RECOVERY_FSTAB := device/moto/addison/twrp.fstab
